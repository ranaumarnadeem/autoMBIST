...
See [Fault coverage](../README.md#fault-coverage) for the measured MATS+ / March C- / March SS
...
[`flow/multimem/`](../flow/multimem/) and [`flow/multimem/mbist/`](../flow/multimem/mbist/).
...
Reference result (from [`flow/multimem/README.md`](../flow/multimem/README.md)): the 3-macro
subsystem closes in LibreLane 3.0.5 at **0.78 mm² die, ~51% memory area, 4,158 std cells,
0 detailed-routing violations, LVS-clean including power.**
