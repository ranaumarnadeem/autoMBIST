...
| Fault model | Structural array faults (stuck-at, transition, port-coupling) | 43 functional fault primitives |
...
`fault_primitives.py` is a declarative DSL: 37 of the 43 built-in fault types
