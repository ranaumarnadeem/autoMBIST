...
module checkerboard_top #(
    ...
    // On-chip BIRA streaming interface -- pass-through of the FSM's own
    // fail_valid/fail_addr. Unconnected/unused by every existing consumer.
